...
class Menu:
    ...
    # def Admin_AnalyzeSales(self, machineTotalSalesCount, machineTotalPrice):
    ...
    #         self.Admin_AnalyzeSales(self.totalSalesCount,self.totalPrice)
    #     elif adminChoice == "7" or adminChoice == "초기화" or adminChoice == "판매량초기화":
    #         self.Admin_SalesReset()
